...
void t_simderr();
void t_syscall();
void t_irq0();  void t_irq1();  void t_irq2();  void t_irq3();
void t_irq4();  void t_irq5();  void t_irq6();  void t_irq7();
void t_irq8();  void t_irq9();  void t_irq10(); void t_irq11();
void t_irq12(); void t_irq13(); void t_irq14(); void t_irq15();
...
trap_init(void)
{
	...
	// IRQ gates (hardware interrupts, DPL=0)
...
page_fault_handler(struct Trapframe *tf)
{
	...
	// LAB 3: Your code here.
	if ((tf->tf_cs & 3) == 0)
		panic("page_fault_handler: kernel-mode page fault at va %08x, eip %08x",
		      fault_va, tf->tf_eip);
	...
	if (curenv->env_pgfault_upcall) {
		...
		// If already on exception stack (recursive), leave a word gap
